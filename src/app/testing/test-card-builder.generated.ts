    ...
    edgeCases: {
      ...
      chartData: {
        ...
        datasets: [
          ...
          {
            label: 'Large',
            data: [1000000, 2000000, 1500000, 2500000, 3000000],
          },
        ],
      },
    },
    ...
    complete: {
      ...
      fields: [
        ...
        },
        {
          label: 'CTO Review',
          value:
            '"The technical implementation was seamless and the support team was exceptional."',
...
export class TestCardBuilder {
  ...
  withEntitySections(variant: FixtureVariant = 'complete'): TestCardBuilder {
    const entitySections: SectionFixtureType[] = [
      'contact-card',
      'network-card',
      'product',
      'solutions',
  ...
  withDefaultActions(): TestCardBuilder {
    this.config.actions = [
      { label: 'Learn More', type: 'website', variant: 'primary', url: 'https://example.com' },
      {
        ...
        variant: 'secondary',
        email: {
          contact: { name: 'Test', email: 'test@example.com', role: 'Tester' },
          subject: 'Test',
          body: 'Test',
        },
      },
...
export const TestCards = {
   ...
   */
  getSectionTypes: (): SectionFixtureType[] =>
    Object.keys(SECTION_FIXTURES) as SectionFixtureType[],
...
export class RandomTestData {
   ...
   */
  static randomCard(sectionCount = 3): AICardConfig {
