...
const pageContent = `# MagneticTiltService
...
@Component({
  selector: 'app-magnetic-tilt-service-page',
  standalone: true,
  imports: [DocPageComponent],
  template: `<app-doc-page [content]="content"></app-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MagneticTiltServicePageComponent {
  content = pageContent;
}

export default MagneticTiltServicePageComponent;
