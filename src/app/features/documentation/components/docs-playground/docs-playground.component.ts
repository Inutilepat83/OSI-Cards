    ...
    >
      ...
      <div class="playground-toolbar">
        ...
        <div class="toolbar-right">
          ...
          >
            <lucide-icon [name]="layout() === 'vertical' ? 'columns-2' : 'rows-2'" [size]="16"></lucide-icon>
          </button>
          ...
          >
            <lucide-icon [name]="editorTheme() === 'light' ? 'moon' : 'sun'" [size]="16"></lucide-icon>
          </button>
          ...
          >
            <lucide-icon [name]="isFullscreen() ? 'minimize-2' : 'maximize-2'" [size]="16"></lucide-icon>
          </button>
          ...
          <div class="shortcuts-modal" (click)="$event.stopPropagation()">
            ...
            <div class="shortcuts-content">
              <div class="shortcut-group">
                ...
                <div class="shortcut"><kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>F</kbd> <span>Format</span></div>
                <div class="shortcut"><kbd>Tab</kbd> <span>Insert 2 spaces</span></div>
              </div>
              <div class="shortcut-group">
                <h4>View</h4>
                <div class="shortcut"><kbd>Ctrl</kbd>+<kbd>Enter</kbd> <span>Toggle fullscreen</span></div>
              ...
              <div class="shortcut-group">
                ...
                <div class="shortcut"><kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd> <span>Copy link</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      @if (toast()) {
        <div class="toast" [class.error]="toast()!.type === 'error'" [class.success]="toast()!.type === 'success'">
          <lucide-icon [name]="toast()!.type === 'error' ? 'alert-circle' : 'check-circle'" [size]="16"></lucide-icon>
          {{ toast()!.message }}
        </div>
      }
    </div>
...
export class DocsPlaygroundComponent implements OnInit, OnDestroy {
  ...
  private pushToHistory(code: string) {
    ...
    if (this.history[this.history.length - 1] === code) return;
