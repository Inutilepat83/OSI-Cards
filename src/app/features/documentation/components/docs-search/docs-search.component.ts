      ...
      <div class="search-overlay" (click)="close()">
        ...
        >
            ...
            @if (isLoading()) {
              ...
              <div class="results-section">
                ...
                @for (recent of recentSearches(); track recent) {
                  <button class="result-item recent" (click)="searchRecent(recent)">
              ...
              <div class="results-section">
                ...
                @for (link of quickLinks; track link.path) {
                  <button class="result-item" (click)="navigateTo(link.path)">
                  ...
                  @for (result of group.items; track result.id; let i = $index) {
                    ...
                    >
                      ...
                      <div class="result-content">
                        ...
                        <span
                          class="result-title"
                          [innerHTML]="highlightMatch(result.title)"
                        ></span>
                        @if (result.excerpt) {
                          <span
                            class="result-excerpt"
                            [innerHTML]="highlightMatch(result.excerpt)"
                          ></span>
                        }
                      </div>
              ...
              <div class="no-results">
                ...
                <div class="suggestions">
                  <button class="suggestion-btn" (click)="searchSuggestion('getting started')">
                    Getting Started
                  </button>
                  <button class="suggestion-btn" (click)="searchSuggestion('section types')">
                    Section Types
                  </button>
                  <button class="suggestion-btn" (click)="searchSuggestion('streaming')">
                    Streaming
                  </button>
                  <button class="suggestion-btn" (click)="searchSuggestion('theming')">
                    Theming
                  </button>
                </div>
              </div>
          ...
          <div class="search-footer">
            <div class="footer-hint"><kbd>↑↓</kbd> to navigate</div>
            <div class="footer-hint"><kbd>↵</kbd> to select</div>
            <div class="footer-hint"><kbd>esc</kbd> to close</div>
          </div>
        </div>
      </div>
    }
...
export class DocsSearchComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  quickLinks = [
    ...
    {
      path: '/docs/components/ai-card-renderer',
      title: 'AICardRenderer',
      category: 'Component',
      icon: 'box',
    },
  ...
  private buildSearchIndex() {
    ...
    this.searchIndex = [
      // Guides
      {
        ...
        type: 'guide',
        excerpt: 'Introduction to OSI Cards library',
      },
      {
        id: 'gs-2',
        title: 'Installation',
        ...
        categoryIcon: 'book-open',
        type: 'guide',
        excerpt: 'How to install OSI Cards',
      },
      {
        id: 'gs-3',
        ...
        categoryIcon: 'book-open',
        type: 'guide',
        excerpt: 'Recommended patterns and practices',
      },
      {
        id: 'gs-4',
        title: 'Library Usage',
        path: '/docs/library-usage',
        category: 'Guides',
        categoryIcon: 'book-open',
        type: 'guide',
      },
      {
        ...
        path: '/docs/llm-integration',
        category: 'Guides',
        categoryIcon: 'book-open',
        type: 'guide',
        excerpt: 'Integrating with AI/LLM systems',
      },
      ...
      // Section Types
      {
        id: 'st-1',
        title: 'Info Section',
        path: '/docs/section-types/info',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Display key-value information',
      },
      {
        id: 'st-2',
        title: 'Analytics Section',
        path: '/docs/section-types/analytics',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Metrics and KPIs display',
      },
      {
        id: 'st-3',
        title: 'Contact Card',
        path: '/docs/section-types/contact-card',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Contact information display',
      },
      {
        id: 'st-4',
        title: 'Network Card',
        path: '/docs/section-types/network-card',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
      },
      {
        id: 'st-5',
        title: 'Map Section',
        path: '/docs/section-types/map',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Geographic data visualization',
      },
      {
        id: 'st-6',
        title: 'Chart Section',
        path: '/docs/section-types/chart',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Data visualization charts',
      },
      {
        id: 'st-7',
        title: 'List Section',
        path: '/docs/section-types/list',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
        excerpt: 'Display list of items',
      },
      {
        id: 'st-8',
        title: 'Event Section',
        path: '/docs/section-types/event',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
      },
      {
        ...
        path: '/docs/section-types/product',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
      },
      {
        ...
        path: '/docs/section-types/financials',
        category: 'Section Types',
        categoryIcon: 'layout-grid',
        type: 'section-type',
      },
      ...
      // Components
      {
        ...
        categoryIcon: 'box',
        type: 'component',
        excerpt: 'Main card rendering component',
      },
      {
        id: 'c-2',
        title: 'SectionRenderer',
        path: '/docs/components/section-renderer',
        category: 'Components',
        categoryIcon: 'box',
        type: 'component',
      },
      {
        ...
        categoryIcon: 'box',
        type: 'component',
        excerpt: 'Responsive masonry layout',
      },
      {
        id: 'c-4',
        title: 'CardSkeleton',
        path: '/docs/components/card-skeleton',
        category: 'Components',
        categoryIcon: 'box',
        type: 'component',
      },
      {
        ...
        path: '/docs/components/card-streaming-indicator',
        category: 'Components',
        categoryIcon: 'box',
        type: 'component',
      },
      ...
      // API / Services
      {
        ...
        path: '/docs/services/streaming-service',
        category: 'API',
        categoryIcon: 'code',
        type: 'api',
        excerpt: 'Real-time streaming management',
      },
      {
        id: 'api-2',
        title: 'Theme Service',
        path: '/docs/services/theme-service',
        category: 'API',
        categoryIcon: 'code',
        type: 'api',
      },
      {
        ...
        path: '/docs/services/event-middleware-service',
        category: 'API',
        categoryIcon: 'code',
        type: 'api',
      },
      {
        id: 'api-4',
        title: 'Section Plugin Registry',
        path: '/docs/services/section-plugin-registry',
        category: 'API',
        categoryIcon: 'code',
        type: 'api',
      },
      {
        ...
        path: '/docs/services/animation-orchestrator',
        category: 'API',
        categoryIcon: 'code',
        type: 'api',
      },
      ...
      // Schemas
      {
        id: 'sch-1',
        title: 'AICardConfig',
        path: '/docs/schemas/ai-card-config',
        category: 'Schemas',
        categoryIcon: 'file-json',
        type: 'api',
        excerpt: 'Card configuration schema',
      },
      {
        id: 'sch-2',
        title: 'CardSection',
        path: '/docs/schemas/card-section',
        category: 'Schemas',
        categoryIcon: 'file-json',
        type: 'api',
      },
      ...
      // Streaming
      {
        ...
        path: '/docs/streaming/overview',
        category: 'Streaming',
        categoryIcon: 'radio',
        type: 'guide',
        excerpt: 'Real-time card updates',
      },
      {
        id: 'str-2',
        title: 'Streaming Configuration',
        path: '/docs/streaming/config',
        category: 'Streaming',
        categoryIcon: 'radio',
        type: 'api',
      },
      {
        ...
        path: '/docs/streaming/progressive-rendering',
        category: 'Streaming',
        categoryIcon: 'radio',
        type: 'guide',
      },
      ...
      // Advanced
      {
        ...
        path: '/docs/advanced/theming-overview',
        category: 'Advanced',
        categoryIcon: 'graduation-cap',
        type: 'guide',
        excerpt: 'Customizing card appearance',
      },
      {
        id: 'adv-2',
        title: 'CSS Properties',
        path: '/docs/advanced/css-properties',
        category: 'Advanced',
        categoryIcon: 'graduation-cap',
        type: 'api',
      },
      {
        ...
        path: '/docs/advanced/custom-sections',
        category: 'Advanced',
        categoryIcon: 'graduation-cap',
        type: 'guide',
      },
  ...
  private saveRecentSearch(query: string) {
    if (!query.trim() || typeof localStorage === 'undefined') {
      return;
    }
