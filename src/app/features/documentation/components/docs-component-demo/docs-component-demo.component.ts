...
@Component({
    ...
    <div class="component-demo" [class.dark-preview]="previewTheme() === 'dark'">
      ...
      <div class="demo-toolbar">
        ...
        <div class="toolbar-right">
          ...
          >
            <lucide-icon [name]="previewTheme() === 'light' ? 'moon' : 'sun'" [size]="16"></lucide-icon>
          </button>
  ...
  styles: [`
    ...
    .skeleton-header {
      height: 48px;
      background: linear-gradient(90deg, var(--docs-bg-secondary) 0%, var(--docs-bg-tertiary) 50%, var(--docs-bg-secondary) 100%);
