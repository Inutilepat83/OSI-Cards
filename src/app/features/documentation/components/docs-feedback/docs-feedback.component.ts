    ...
    <div class="page-rating" [class.submitted]="submitted()">
      @if (!submitted()) {
        ...
        <div class="rating-buttons">
          <button class="rating-btn" [class.selected]="rating() === 'yes'" (click)="rate('yes')">
            <lucide-icon name="thumbs-up" [size]="18"></lucide-icon>
            Yes
          </button>
          <button class="rating-btn" [class.selected]="rating() === 'no'" (click)="rate('no')">
      ...
      <div class="community-cards">
        ...
        @if (discussionsUrl) {
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="community-card discussions"
          >
    ...
    `
      .contribute-section {
        ...
        background: linear-gradient(
          135deg,
          var(--docs-primary-bg, rgba(255, 121, 0, 0.06)) 0%,
