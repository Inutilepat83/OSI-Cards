...
const pageContent = `# Progressive Rendering
...
@Component({
  selector: 'app-progressive-rendering-page',
  standalone: true,
  imports: [DocPageComponent],
  template: `<app-doc-page [content]="content"></app-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProgressiveRenderingPageComponent {
  content = pageContent;
}

export default ProgressiveRenderingPageComponent;
