...
import pageConfig from './theming.page';

const pageContent: string = `# OSI Cards Library - Theming Guide
...
@Component({
  selector: 'ng-doc-page-theming',
  template: `<ng-doc-page></ng-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgDocPageComponent],
  providers: [
    { provide: NgDocRootPage, useExisting: ThemingPageComponent }
  ],
  standalone: true
})
export class ThemingPageComponent extends NgDocRootPage {
...
export default ThemingPageComponent;
