...
import pageConfig from './agentic-flow.page';

const pageContent: string = `# OSI Cards Library - Agentic Flow Integration Guide
...
@Component({
  selector: 'ng-doc-page-agentic-flow',
  template: `<ng-doc-page></ng-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgDocPageComponent],
  providers: [
    { provide: NgDocRootPage, useExisting: AgenticFlowPageComponent }
  ],
  standalone: true
})
export class AgenticFlowPageComponent extends NgDocRootPage {
...
export default AgenticFlowPageComponent;
