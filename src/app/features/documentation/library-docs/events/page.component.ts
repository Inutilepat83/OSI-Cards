...
import pageConfig from './events.page';

const pageContent: string = `# OSI Cards Library - Event System Guide
...
@Component({
  selector: 'ng-doc-page-events',
  template: `<ng-doc-page></ng-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgDocPageComponent],
  providers: [
    { provide: NgDocRootPage, useExisting: EventsPageComponent }
  ],
  standalone: true
})
export class EventsPageComponent extends NgDocRootPage {
