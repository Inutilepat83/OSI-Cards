...
import pageConfig from './services.page';

const pageContent: string = `# OSI Cards Library - Services Documentation
...
@Component({
  selector: 'ng-doc-page-services',
  template: `<ng-doc-page></ng-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgDocPageComponent],
  providers: [
    { provide: NgDocRootPage, useExisting: ServicesPageComponent }
  ],
  standalone: true
})
export class ServicesPageComponent extends NgDocRootPage {
