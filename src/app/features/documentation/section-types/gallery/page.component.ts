...
const pageContent = `# Gallery Section
...
- **Style Path:** \`./lib/components/sections/gallery-section/gallery-section.scss\`
...
/**
 * Gallery Section documentation page with live demo
