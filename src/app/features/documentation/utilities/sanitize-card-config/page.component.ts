...
const pageContent = `# sanitizeCardConfig
...
@Component({
  selector: 'app-sanitize-card-config-page',
  standalone: true,
  imports: [DocPageComponent],
  template: `<app-doc-page [content]="content"></app-doc-page>`,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SanitizeCardConfigPageComponent {
  content = pageContent;
}

export default SanitizeCardConfigPageComponent;
