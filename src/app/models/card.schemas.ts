...
export const cardSectionSchema = z
  .object({
    ...
    preferredColumns: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4)]).optional(),
    minColumns: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4)]).optional(),
    maxColumns: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4)]).optional(),
    ...
    layoutPriority: z.union([z.literal(1), z.literal(2), z.literal(3)]).optional(),
    columnAffinity: z.number().int().min(0).optional(),
