...
export const contactTemplateVariants: AICardConfig[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'analytics',
        fields: [
          { id: 'emailOpens', label: 'Email Opens', value: '120', percentage: 80, trend: 'up', change: 15 },
          { id: 'meetingCount', label: 'Meetings Held', value: '8', percentage: 67, trend: 'neutral', change: 2 },
          { id: 'responseTime', label: 'Avg. Response Time (hrs)', value: '24', percentage: 50, trend: 'down', change: -5 },
          { id: 'networkScore', label: 'Network Influence', value: '88', percentage: 88, trend: 'up', change: 8 }
        ]
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'analytics',
        fields: [
          { id: 'rfpSubmissions', label: 'RFP Submissions', value: '15', percentage: 75, trend: 'up', change: 25 },
          { id: 'responseRate', label: 'Response Rate', value: '65%', percentage: 65, trend: 'neutral', change: 3 },
          { id: 'vendorMeetings', label: 'Vendor Meetings', value: '5', percentage: 42, trend: 'down', change: -2 },
          { id: 'procurementInfluence', label: 'Procurement Influence', value: '72', percentage: 72, trend: 'up', change: 6 }
        ]
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'analytics',
        fields: [
          { id: 'networkUptime', label: 'Network Uptime', value: '99.8%', percentage: 98, trend: 'up', change: 2 },
          { id: 'incidentResponse', label: 'Incident Response Time', value: '15 min', percentage: 85, trend: 'down', change: -3 },
          { id: 'securityAlerts', label: 'Security Alerts', value: '2', percentage: 90, trend: 'down', change: -5 },
          { id: 'teamCollaboration', label: 'Team Collaboration', value: '80', percentage: 80, trend: 'up', change: 10 }
        ]
      },
      {
        id: 'network-projects',
