    ...
    actions: [
      {
        ...
        type: 'primary',
        icon: '📄',
        action: 'https://crm.orange.com/opps/enterprise-connectivity'
      },
      {
        id: 'schedule-call',
        label: 'Schedule Call',
        type: 'primary',
        icon: '📞',
        action: 'https://crm.orange.com/opps/book?opp=enterprise-connectivity'
      }
    ]
  },
  {
    ...
    actions: [
      {
        ...
        type: 'primary',
        icon: '📂',
        action: 'https://crm.orange.com/opps/cloud-migration/docs'
      },
      {
        id: 'assign-task',
        label: 'Assign Task',
        type: 'primary',
        icon: '📝',
        action: 'https://crm.orange.com/opps/task/new?opp=cloud-migration'
      }
    ]
  },
  {
    ...
    actions: [
      {
        ...
        type: 'primary',
        icon: '📥',
        action: 'https://crm.orange.com/opps/security-assessment/report'
      },
      {
        id: 'create-note',
        label: 'Add CRM Note',
        type: 'primary',
        icon: '🗒️',
        action: 'https://crm.orange.com/opps/note/new?opp=security-assessment'
      }
    ]
  }
];
