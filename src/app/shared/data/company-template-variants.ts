...
export const companyTemplateVariants: AICardConfig[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        preferredColumns: 2,
        fields: [
          { id: 'annual-ict-budget', label: 'Annual ICT Budget', value: '€200M', percentage: 100, trend: 'up', change: 8 },
          { id: 'cloud-investment', label: 'Cloud Investment', value: '€50M', percentage: 25, trend: 'up', change: 15 },
          { id: 'digital-transformation', label: 'Digital Transformation', value: '€75M', percentage: 37, trend: 'up', change: 22 },
          { id: 'security-spend', label: 'Cybersecurity Budget', value: '€25M', percentage: 12, trend: 'stable', change: 5 }
        ]
      },
      {
        id: 'cloud-services',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'analytics',
        fields: [
          { id: 'digital-budget', label: 'Digital Budget', value: '€300M', percentage: 100, trend: 'up', change: 12 },
          { id: 'iot-investment', label: 'IoT & Smart Brewing', value: '€70M', percentage: 23, trend: 'up', change: 25 },
          { id: 'data-analytics', label: 'Data & Analytics', value: '€90M', percentage: 30, trend: 'up', change: 18 },
          { id: 'automation', label: 'Automation & AI', value: '€65M', percentage: 22, trend: 'up', change: 30 }
        ]
      },
      {
        id: 'cloud-services',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'analytics',
        fields: [
          { id: 'it-budget', label: 'IT Budget', value: '€180M', percentage: 100, trend: 'up', change: 10 },
          { id: 'cloud-transformation', label: 'Cloud Transformation', value: '€60M', percentage: 33, trend: 'up', change: 20 },
          { id: 'r-and-d-digital', label: 'Digital R&D', value: '€45M', percentage: 25, trend: 'up', change: 35 },
          { id: 'automation', label: 'Manufacturing Automation', value: '€35M', percentage: 19, trend: 'stable', change: 8 }
        ]
      },
      {
