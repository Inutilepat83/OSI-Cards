...
describe('CardUtils', () => {
  describe('ensureCardIds', () => {
    it('should add IDs to card without ID', () => {
      const card = CardBuilder.create().withTitle('Test Card').build();
    ...
    it('should preserve existing card ID', () => {
      const card = CardBuilder.create().withId('existing-id').withTitle('Test Card').build();
    ...
    it('should add IDs to sections without IDs', () => {
      ...
      const card = CardBuilder.create().withTitle('Test Card').withSection(section).build();
    ...
    it('should add IDs to fields without IDs', () => {
      ...
      const card = CardBuilder.create()
        .withTitle('Test Card')
        .withSection(SectionBuilder.create().withTitle('Section 1').withField(field).build())
        .build();
  ...
  describe('removeAllIds', () => {
    ...
    it('should preserve other properties', () => {
      const card = CardBuilder.create().withId('card-id').withTitle('Test Card').build();
    ...
    it('should handle empty sections array', () => {
      const card = CardBuilder.create().withTitle('Test Card').withSections([]).build();
    ...
    it('should handle sections with empty fields array', () => {
      const card = CardBuilder.create()
        .withTitle('Test Card')
        .withSection(SectionBuilder.create().withTitle('Section 1').withFields([]).build())
        .build();
  ...
  describe('Edge cases for ensureCardIds', () => {
    ...
    it('should handle very long titles', () => {
      ...
      const card = CardBuilder.create().withTitle(longTitle).build();
      delete (card as any).id;
    ...
    it('should handle special characters in titles', () => {
      const card = CardBuilder.create().withTitle('Card @#$%^&*()').build();
      delete (card as any).id;
    ...
    it('should handle card with many sections', () => {
      const sections = Array.from({ length: 100 }, (_, i) =>
        SectionBuilder.create().withTitle(`Section ${i}`).build()
      );

      const card = CardBuilder.create().withTitle('Test Card').withSections(sections).build();
    ...
    it('should handle section with many fields', () => {
      const fields = Array.from({ length: 50 }, (_, i) =>
        FieldBuilder.create().withLabel(`Field ${i}`).build()
      );

      const card = CardBuilder.create()
        .withTitle('Test Card')
        .withSection(SectionBuilder.create().withTitle('Section 1').withFields(fields).build())
        .build();
