...
import { StreamParseError, StreamJsonError } from './streaming-errors';
...
export class StreamingJsonParser {
  ...
  private extractBalancedObject(str: string, startIndex: number): { endIndex: number; json: string | null } {
    let braceDepth = 0;
    let inString = false;
