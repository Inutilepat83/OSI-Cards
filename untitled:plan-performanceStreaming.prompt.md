...
Steps
1. Document the blocking fetch path in `src/app/core/services/card-data/card-data.service.ts`, `json-card-provider.service.ts`, and `src/app/store/cards/cards.effects.ts`.
