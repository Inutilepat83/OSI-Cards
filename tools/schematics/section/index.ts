      ...
      registry.sections[type] = {
        ...
        examples: {
          example: {
            ...
            type: type,
            description: `Representative ${name} section example demonstrating all available features`,
            preferredColumns: options.defaultColumns || 1,
            priority: 3,
            [options.usesItems ? 'items' : 'fields']: options.usesItems
              ? [
                  { title: 'Example Item 1', description: 'Item description with details' },
                  { title: 'Example Item 2', description: 'Another item showing different cases' }
                ]
              : [
                  { label: 'Example Label 1', value: 'Example Value 1' },
                  { label: 'Example Label 2', value: 'Example Value 2' }
                ]
          }
        }
      };
