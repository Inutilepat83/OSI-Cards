  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Nexus supports 200+ native connectors including cloud databases (Snowflake, BigQuery, Redshift), CRM systems (Salesforce, HubSpot), ERP platforms (SAP, Oracle, NetSuite), file storage (S3, Azure Blob), and popular SaaS tools. We also offer a REST API for custom integrations and CSV/Excel file uploads for ad-hoc analysis.',
        meta: {
          category: 'Technical',
        },
      },
      ...
      },
      {
        ...
        description:
          'Yes! We offer a 14-day free trial with full access to all features. You can connect your own data or explore with sample datasets. For enterprise evaluations, we provide extended POC periods with dedicated technical support. No credit card required to start your trial.',
        meta: {
      ...
      },
      {
        ...
        description:
          'All plans include email support with 24-hour response SLA and access to our comprehensive documentation and video tutorials. Business plans add live chat support. Enterprise customers receive 24/7 phone support, dedicated Customer Success Manager, and quarterly business reviews.',
        meta: {
          category: 'Support',
        },
      },
    ...
    fields: [
      {
        ...
        value:
          '"Nexus Analytics has fundamentally transformed how we approach data-driven decision making. Within six months of deployment, we\'ve seen a 47% reduction in time-to-insight and our business users are now self-sufficient in creating their own reports. The ROI has been extraordinary."',
      ...
      },
      {
        ...
        value:
          '"In healthcare, data accuracy and compliance are non-negotiable. Nexus not only meets our stringent HIPAA requirements but has enabled our research teams to discover patterns that were previously invisible. We\'ve accelerated our clinical trial analysis by 10x."',
      ...
      },
      {
        ...
        value:
          '"The real-time analytics capabilities have been game-changing for our trading desk. We\'re now making decisions in milliseconds that used to take hours. Our risk management team has never been more confident in their data."',
      ...
      },
      {
        ...
        value:
          '"We integrated Nexus with our IoT sensors across 12 manufacturing plants. The predictive maintenance insights alone have saved us $15M annually in unplanned downtime. It\'s become the central nervous system of our operations."',
      ...
      },
      {
        ...
        value:
          '"Nexus Technologies continues to set the standard for modern analytics platforms. Their AI-first approach and commitment to user experience puts them firmly in the Leader quadrant, with the highest scores for innovation and customer satisfaction."',
    ...
    items: [
      {
        ...
        description:
          'Dr. Sarah Mitchell and James Park launch Nexus Technologies in Austin, TX with a vision to democratize data analytics for enterprises',
        meta: {
          date: 'March 2018',
          year: '2018',
          icon: '🚀',
      ...
      },
      {
        ...
        description:
          'Signed first Fortune 500 customer, validating product-market fit for enterprise analytics segment',
        meta: {
          date: 'February 2019',
          year: '2019',
          icon: '🎯',
...
export const EDGE_CASE_FIXTURES: Record<string, CardSection> = {
      ...
      datasets: [
        {
          ...
          data: [-50, -25, -10, 0, 15, 30, 45, 35, 20, 5, -15, -30],
        },
        {
          label: 'Large Scale',
          data: [
            1000000, 2500000, 1800000, 3200000, 2900000, 4100000, 3800000, 4500000, 5200000,
            4800000, 5800000, 6200000,
          ],
        },
        {
          label: 'Sparse Data',
          data: [0, 0, 100, 0, 0, 200, 0, 0, 300, 0, 0, 400],
        },
      ],
    },
  },
  ...
  faq: {
    ...
    items: [
      ...
      {
        title:
          'Very long question that exceeds normal length and should wrap properly across multiple lines without breaking the accordion component layout?',
  ...
  gallery: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'This is a very long description that should properly wrap and not break the gallery layout even when it contains significantly more text than typical image captions',
      },
      {
        title: '日本語キャプション',
  ...
  info: {
    ...
    fields: [
      ...
      },
      {
        label: 'Short',
        value:
          'This is a very long value that should wrap properly across multiple lines without breaking the layout',
      },
      {
        label: 'Numeric',
        value: 12345.6789,
  ...
  list: {
    ...
    items: [
      ...
      {
        title:
          'Very Long Title That Should Wrap Properly Across Multiple Lines Without Breaking Layout',
        description: 'Short description',
      },
      {
        title: 'Short',
        description:
          'This is an extremely long description that contains a lot of information and should properly wrap across multiple lines while maintaining readability and not breaking the overall layout of the card section component',
      },
    ],
  },
  map: {
...
export const SAMPLE_ANALYTICS_CARD: AICardConfig = {
  ...
  cardType: 'analytics',
  sections: [COMPLETE_FIXTURES['analytics']!, COMPLETE_FIXTURES['chart']!].filter(Boolean),
};
...
export function getFixture(
  ...
  switch (category) {
    case 'complete':
      return fixtures.complete;
    case 'minimal':
      return fixtures.minimal;
    case 'edge-case':
      return fixtures.edgeCase;
    default:
      return fixtures.complete;
  }
}
